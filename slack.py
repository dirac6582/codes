...
def install_slack():
    ...
    return redirect('https://slack.com/oauth/v2/authorize?client_id=165336660452.2873960700565&scope=incoming-webhook&user_scope=')
...
def slack_oauth():
    if (request.method == 'GET'):
        ...
        oauth_data['client_id'] = '165336660452.2873960700565'
        oauth_data['client_secret'] = '23dce85601894a8709213f8598d441f4'
